    ...
    <footer className="relative z-10 mt-8 py-6 bg-gray-100 border-t border-gray-200">
      <div className="max-w-6xl mx-auto px-6 text-center">
        <div className="flex flex-col md:flex-row justify-center items-center gap-4 text-gray-700">
          ...
          <a 
            href="https://github.com/tippi-fifestarr/gastest" 
            target="_blank" 
            rel="noopener noreferrer"
        ...
        <div className="mt-4 space-y-2 text-xs text-gray-500">
          ...
          <p>Showcasing: Gas Station Sponsorship • Wallet Adapter • TypeScript SDK</p>
        </div>
      </div>
    </footer>
  );
